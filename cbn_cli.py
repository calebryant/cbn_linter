...
def generate(args):
  ...
  """
  sample_sizes = ['1', '10', '1000', '10000']
  sample_names = ['1', '10', '1k', '10k']
...
# Added by Cyderes
def lint_parser(args):
  """Lints a given .conf file"""
  print('\n[cbn_cli]: Linting parser... ', flush=True)
  return
...
def arg_parser():
  ...
  # "lint" command
  lint_command = subparsers.add_parser(
      'lint', help='Runs given .conf file through the Cyderes CBN linter')
  lint_command.add_argument(
      '-c', '--conf_file', required=True, help='CBN .conf file')
  lint_command.set_defaults(func=lint_parser)
  return parser
